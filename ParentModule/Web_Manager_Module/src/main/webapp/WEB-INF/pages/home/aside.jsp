        ...
        <ul class="sidebar-menu">
            ...
            <c:if test="${module.ctype == 0}">
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <c:forEach items="${sessionScope.moduleList}" var="one">
                        <c:if test="${one.ctype == 1 && one.parentId == module.id}">
                            <li id="${one.id}">
                                <a href="${one.curl}" onclick="setSidebarActive(this)" target="iframe">
                                    <i class="fa fa-circle-o"></i>${one.name}
                                </a>
                            </li>
                        </c:if>
                        </c:forEach>
