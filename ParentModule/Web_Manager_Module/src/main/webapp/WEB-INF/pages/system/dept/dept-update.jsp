                            ...
                            <div class="tab-pane active" id="tab-form">
                                <div class="row data-type">
                                    ...
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control" placeholder="部门名称" name="deptName" value="${department.deptName}">
                                    </div>
                                    ...
                                    <div class="col-md-10 data line-height36">
                                        <select class="form-control" name="parentDept.deptId">
                                            ...
                                            <c:forEach items="${departmentList}" var="item">
                                                <option ${department.parentDept.deptId == item.deptId ?'selected':''} value="${item.deptId}">${item.deptName}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
